...
class POSTagger:
    ...
    def generate(self, sentence: str):
        ...
        # we do some cleaning here since bad word and such might get split up into multiple words and each might possibly
        # be tagged as differeent parts of speech. moreover we need to combine them again.
